# Mapeo símbolo -> sector GICS, obtenido de la lista de constituyentes del S&P 500.
# Se usa para agrupar las posiciones del portafolio en el Árbol del Portafolio
# (ver app/data_structures/portfolio_tree.py).
# Los símbolos que no están aquí caen en "Other" (ver SECTORES_POR_SIMBOLO.get(simbolo, "Other") en ui.py).
# Nota: los nombres de sector se dejan en inglés porque son la taxonomía oficial GICS, no nombres de variables.
SECTORES_POR_SIMBOLO = {
    'A': 'Health Care',
